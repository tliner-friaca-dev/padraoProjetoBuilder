...
import br.com.projeto.padraoProjetoBuilder.builderClasseSeparada.model.builder.PedidoVendaBuilder;

@SpringBootTest
@DisplayName("BuilderApplicationTestsClasseSeparada")
class BuilderApplicationTestsClasseSeparada {
